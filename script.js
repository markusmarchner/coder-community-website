const translations = {
  de: {
    ...
    heroImageAria: "Coder Videoanalyse auf einem Desktop",
    videoCategoriesAria: "Videokategorien",
    ...
    featureTwoTitle: "Präsentation & Panels",
    featureTwoText:
      "Material vorbereiten, Ergebnisse zeigen und Diskussionen nachvollziehen.",
    ...
    mobileVideoTitle: "Coder Mobile Overview Video",
    mobileVideoText:
      "Das Overview Video zeigt den Live-Tagging Workflow am Spielfeldrand und im Training.",
    mobileVideoFrameTitle: "Coder Mobile Overview Video",
    mobileVideoPlaceholder: "Coder Mobile Overview Video",
  ...
  en: {
    ...
    heroImageAria: "Coder video analysis on a desktop",
    videoCategoriesAria: "Video categories",
    ...
    featureTwoTitle: "Presentation & panels",
    featureTwoText:
      "Prepare material, present results, and make discussions traceable.",
    featureThreeTitle: "Import & export",
    featureThreeText:
    ...
    mobileVideoTitle: "Coder Mobile Overview Video",
    mobileVideoText:
      "The overview video shows the live tagging workflow at pitch side and in training.",
    mobileVideoFrameTitle: "Coder Mobile Overview Video",
    mobileVideoPlaceholder: "Coder Mobile Overview Video",
  ...
  fr: {
    ...
    heroImageAria: "Analyse vidéo Coder sur un ordinateur de bureau",
    videoCategoriesAria: "Catégories de vidéos",
    ...
    featureTwoTitle: "Présentation & panels",
    featureTwoText:
      "Préparez le matériel, présentez les résultats et rendez les discussions traçables.",
    featureThreeTitle: "Import & export",
    featureThreeText:
    ...
    mobileVideoTitle: "Vidéo d’aperçu de Coder Mobile",
    mobileVideoText:
      "La vidéo d’aperçu montre le workflow de tagging en direct au bord du terrain et à l’entraînement.",
    mobileVideoFrameTitle: "Vidéo d’aperçu de Coder Mobile",
    mobileVideoPlaceholder: "Vidéo d’aperçu de Coder Mobile",
  ...
  es: {
    ...
    heroImageAria: "Análisis de vídeo de Coder en un escritorio",
    videoCategoriesAria: "Categorías de vídeo",
    ...
    featureTwoTitle: "Presentación & paneles",
    featureTwoText:
      "Prepara material, presenta resultados y haz que las discusiones sean trazables.",
    ...
    mobileVideoTitle: "Vídeo general de Coder Mobile",
    mobileVideoText:
      "El vídeo general muestra el flujo de etiquetado en directo junto al campo y en entrenamientos.",
    mobileVideoFrameTitle: "Vídeo general de Coder Mobile",
    mobileVideoPlaceholder: "Vídeo general de Coder Mobile",
...
let currentLanguage = translations[localStorage.getItem("coder-language")]
  ? localStorage.getItem("coder-language")
  : "de";
...
function selectVideo(key) {
  ...
  tabs.forEach((tab) => {
    const tabVideo = videos[tab.dataset.video];
    const isActive = tab.dataset.video === key;

    if (tabVideo) {
      tab.textContent = tabVideo.label;
    }
